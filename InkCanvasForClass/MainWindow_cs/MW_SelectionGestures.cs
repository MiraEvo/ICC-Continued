    ...
    public partial class MainWindow : Window {
        ...
        private void StrokeSelectionBorderHandle_MouseUp(object sender, MouseButtonEventArgs e) {
            ...
            if (!lockedStrokeSelectionBorderHandleType.HasValue) {
                ...
                if (lockedStrokeSelectionHandle != null) {
        ...
        private void GridInkCanvasSelectionCover_ManipulationDelta(object sender, ManipulationDeltaEventArgs e) {
            try {
                if (dec.Count >= 1) {
                    ...
                    foreach (var stroke in strokes) {
                        ...
                        try {
                            ...
                            LogHelper.WriteLogToFile("Exception in MW_SelectionGestures.cs: " + ex.Message, LogHelper.LogType.Error);
                        }
                    }
                ...
                LogHelper.WriteLogToFile("Exception in MW_SelectionGestures.cs (Top Level): " + ex.Message, LogHelper.LogType.Error);
            }
        }
        ...
        private void SelectionV2Init() {
            SelectionV2.SelectAllEvent += (sender, args) => {
                ...
                // 过滤掉锁定的笔画，避免选中整个屏幕
                var selectableStrokes = new StrokeCollection(
                    inkCanvas.Strokes.Where(stroke => !stroke.ContainsPropertyData(IsLockGuid))
                );
                inkCanvas.Select(selectableStrokes);
